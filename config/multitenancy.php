...
return [
     ...
     *
     */
    'tenant_finder' => Spatie\Multitenancy\TenantFinder\DomainTenantFinder::class, // null,
     ...
     */
    'switch_tenant_tasks' => [
            // separate caches for each different tenant
            // This task only works for memory based caches, such as APC and Redis.
     ...
     */
    'tenant_database_connection_name' => env('DB_CONNECTION2', 'tenant'),

    /*
     * The connection name to reach the landlord database
     */
    'landlord_database_connection_name' => env('DB_CONNECTION', 'hq'),
     ...
     */
    // all tenants use the same routes
